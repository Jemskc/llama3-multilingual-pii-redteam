...
# 1. CONFIGURATION
# ==========================================
INPUT_FILE = "french_train.csv"
OUTPUT_FILE = "french_prepared.jsonl"
...
def load_and_clean_csv(filepath):
    ...
    # Critical: Strip whitespace to fix " NER..." header bug
...
def find_ner_column(df):
    """Dynamically finds the mislabeled NER column."""
    for col in df.columns:
        # Look for 'NER' and 'SPANISH' (case insensitive)
...
def process_french():
    print("-" * 60)
    print("PROCESSING FRENCH DATA FOR FINE-TUNING")
    print("-" * 60)
